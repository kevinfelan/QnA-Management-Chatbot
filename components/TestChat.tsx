...
export default function TestChat({
  ...
  return (
    <div className="flex h-[calc(100svh-320px)] min-h-[420px] flex-col overflow-hidden rounded-xl border border-navy/10 bg-white">
      ...
      <form onSubmit={handleSend} className="flex items-center gap-2 border-t border-navy/10 p-3">
        <input
          ...
          disabled={sending}
          className="flex-1 rounded-full border border-navy/20 px-4 py-2 text-sm outline-none focus:border-teal focus:ring-1 focus:ring-teal disabled:opacity-50"
        />
        <button
          type="submit"
          disabled={sending}
